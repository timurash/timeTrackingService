...
export default {
    ...
    data() {
        const validateForSpaces = (rule, value, callback) => {
            if (value.trim() === '' && value !== '') {
        ...
        return {
            ...
            rules: {
                ...
                surname: [
                    ...
                    {
                        validator: validateForSpaces,
                        message: 'Фамилия не должно состоять из пробелов',
                        trigger: 'blur',
                    },
                ],
                patronymic: [
                    ...
                    {
                        validator: validateForSpaces,
                        message: 'Отчество не должно состоять из пробелов',
                        trigger: 'blur'
                    },
                ],
            },
